...
export const mockTasks: Task[] = [
  ...
  // ── DOING ─────────────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { id: 'sub-2', title: 'Mettre à jour les filtres', completed: false, createdAt: now, completedAt: null, completedBy: null },
  ...
  },
  {
    ...
    archivedAt: null,
    subtasks: [
      { id: 'sub-6', title: 'Écrire les scripts de migration', completed: true, createdAt: now, completedAt: now, completedBy: 'sandro' },
      ...
      { id: 'sub-9', title: 'Déployer en production', completed: false, createdAt: now, completedAt: null, completedBy: null },
    ],
    favorite: false,
    deletedAt: null,
  },
  ...
  // ── REVIEW ────────────────────────────────────────────────────────────────
  {
    ...
    archivedAt: null,
    subtasks: [
      { id: 'sub-4', title: 'Mesurer les temps de réponse', completed: true, createdAt: now, completedAt: now, completedBy: 'sandro' },
